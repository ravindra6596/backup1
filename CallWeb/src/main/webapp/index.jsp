				...
				<div class="row1">
					<div class="col-md-12">
						<form action="MakeCall" method="POST">
							...
							<input type="tel" name="to" id="telNumber"
								class="form-control tel" value="+918698965948" /> 
								<input
								type="tel" name="from" id="telNumber" class="form-control tel"
								value="+14322230093	" />
							<div class="num-pad">
								<div class="span4">
									<div class="num">
							...
							<button type="submit" class="btn btn-success btn-block flatbtn"
								name="flag" value="CALL">CALL</button>
							<button type="submit" class="btn btn-danger btn-block flatbtn"
								name="flag" value="DISCONNECT">DISCONNECT</button>
							<br>
						</form>
					</div>
