...
class _LeavesState extends State<Leaves> {
  ...
  String date(dynamic user) {
    return user['applied_on'];
  }

  String fromdate(dynamic user) {
    return user['from_date'];
  }
    ...
    return Scaffold(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                Container(
                                  child: getWidget(snapshot.data[index]),
                                ),
                              ],
                            ),
                          ],
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => AddLeave(new Map())),
          );
        },
