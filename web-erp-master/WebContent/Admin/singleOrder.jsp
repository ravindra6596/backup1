...
Connection con = C3P0DataSource.getInstance().getConnection();
	...
	String sql = "SELECT DATE_FORMAT(o.orderdate, '%d-%m-%Y') as odate, e.name as empname,c.name AS cname FROM order_products op INNER JOIN orders o ON o.orderid = op.orderid INNER JOIN chemists c on c.cid = o.cid INNER JOIN employee e ON e.eid = o.eid WHERE o.orderid = '"
			+ orderid + "' LIMIT 1";
